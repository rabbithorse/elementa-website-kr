<template>
  <div>
    ...
    <section class="wetheworld-section flex items-center justify-center overflow-hidden h-dvh" ref="wetheworldSection">
      ...
      <h2 class="flex items-center 2xl:text-[272px] xl:text-[220px] md:text-[180px] text-[25.3vw] leading-1 font-bold text-white text-center h-0 overflow-clip absolute" ref="inspireText">
