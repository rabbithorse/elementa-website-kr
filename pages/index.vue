  ...
  <div>
    <section ref="visualSection" class="visual-section h-screen relative overflow-hidden">
      ...
      <div class="mission-section flex flex-col xl:gap-y-16 md:gap-y-10 gap-y-8 justify-center items-center relative" ref="missionSection">
        <div class="text-wrap w-full fade-text">
          <h2 class="2xl:text-[13.75rem] xl:text-[185px] md:text-[150px] leading-1 font-bold text-white">
            ...
            <div class="bottom-line relative">
              <div ref="newParadigm" class="leading-none gradient-text blue text-[length:inherit] md:flex-nowrap flex-wrap justify-center pt-1.5" >
                  ...
                  <div class="character-wrap inline-block overflow-clip ">
                    <div class="primary-character primary-character--disappear">
                      <!-- <svg xmlns="http://www.w3.org/2000/svg" width="40" height="179" viewBox="0 0 40 179" fill="none" class="aspect-[40/177]">
                      ...
                      <img src="~assets/images/main/gradient/paradigm-i.svg" alt="" class="aspect-[40/177]">
                    </div>
                  </div>
                  <div class="character-wrap inline-block overflow-clip ">
                    <div class="primary-character primary-character--disappear">
                ...
                <span class="primary-text">
                  ...
                  <div class="character-wrap inline-block overflow-clip ">
                    <div class="primary-character--delay">
                      ...
                      <img src="~assets/images/main/gradient/lasting-i.svg" alt="" class="aspect-[40/177]">
                    </div>
                  </div>
                  <div class="character-wrap inline-block overflow-clip ">
                    <div class="primary-character--delay">
                ...
                <span class="primary-text">
                  <div class="character-wrap inline-block overflow-clip ">
                    <div class="primary-character--delay">
                      ...
                      <img src="~assets/images/main/gradient/impact-i.svg" alt="" class="aspect-[40/177]">
                    </div>
                  </div>
                  <div class="character-wrap inline-block overflow-clip ">
                    <div class="primary-character--delay">
    ...
    <section class="newsroom-section relative md:pt-[6.25rem] pt-[3.25rem] pb-[6rem] xl:min-h-dvh sm:min-h-[50svh] min-h-svh" ref="newsroomSection">
...
const missionContentWrap = ref(null)
...
function initAnimation() {
  ...
  videoWrap.value.removeAttribute('style');
  ...
  ctx = $gsap.context(() => {
    ...
    $ScrollTrigger.matchMedia({
      "(min-width: 1024px)": function() {
        ...
        const anim1 = $gsap.timeline({ paused: true })
          ...
          .fromTo(missionBox.value, 
            ...
            { yPercent: 0, opacity: 1, duration: 1.2, ease: 'power4.out' }, 1
          )
      ...
      "(max-width: 1023px)": function() {
        ...
        $gsap.to(missionSection.value.querySelectorAll('.fade-text'), {
          opacity: 1,
          duration: 0.6,
          scrollTrigger: {
            trigger: missionSection.value,
        ...
        // 각 애니메이션을 개별 타임라인으로 생성 (paused 상태)
        const anim1 = $gsap.timeline({ paused: true, timeScale: 0.6 })
          .to(characterDisappearArray, {
            xPercent: 102,
            duration: 0.05,
            ease: "power1.out",
...
function handleScrollTopReset() {
  if (!isIOS()) return

  const currentY = window.scrollY

  if (lastScrollY > 100 && currentY === 0) {
